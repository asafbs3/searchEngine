...
public class AppController {
    ...
    @RequestMapping(value = "/sendAWS", method = RequestMethod.POST)
    public String sendAws(@RequestBody CrawlerRequest request) throws IOException, InterruptedException {
        awsProducer.send(request);
        return "OK";
    }
}
